...
const BlogHero = () => {
  ...
  return (
    <div
      className="sm:min-h-[full] bg-white sm:bg-hero-bg flex items-stretch min-w-full pt-10 sm:pt-24"
      style={{
    ...
    >
      <div
        className="h-full self-center gap-10 p-8 sm:p-4 sm:py-36 lg:pl-20 lg:pr-20 flex flex-col
      ...
      >
        <div className="md:w-[40%] flex flex-col gap-10">
          ...
          <div className="hidden w-[50%] md:block lg:hidden">
            <Link
              href="/blog"
        ...
        <div className="md:w-[45%]">
          ...
          <div className="sm:hidden mt-5 text-center">
            <h2 className="text-primary font-bold text-xl">Lorem ipsum dolor sit amet consectetur.</h2>
            <p className="text-[#232323] text-justify text-sm mt-4">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Nihil dicta quia possimus pariatur molestias esse voluptatem similique non consequuntur magni veritatis.</p>
          </div>
        </div>
      </div>
    </div>
