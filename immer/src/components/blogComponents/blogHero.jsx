...
const BlogHero = () => {
  ...
  return (
    <div
      className="sm:min-h-[75vh] flex items-stretch min-w-full pt-24"
      style={{
    ...
    >
      <div
        className="h-full self-end p-8 sm:p-12 lg:pl-20 lg:pr-20 flex flex-col
        md:flex-row justify-between gap-10"
      >
        <div className="md:w-[45%] flex flex-col gap-10">
          <span className="bg-white h-[1px] w-full flex"></span>
          <h1 className="text-[15vw] sm:text-[12vw] md:text-[8vw] leading-[1.2] text-[#D9D9D9] drop-shadow-[2px_2px_0px_rgba(255,108,0,0.5)] font-bold">
            Explore the world of <span className="text-[#FF6C00]">immer</span>
          </h1>
        ...
        <div className="md:w-[45%]">
          ...
          <div className="mt-5 flex flex-col gap-4">
            ...
            <p className="text-[#FF6C00] text-base md:text-lg">
