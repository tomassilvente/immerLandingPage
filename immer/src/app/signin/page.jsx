...
function Page() {
  ...
  return (
    <div className="flex h-screen bg-white">
      ...
      <h1 className="text-2xl ml-20 text-center text-primary mt-20 sm:mt-0 sm:text-[0px]">Welcome to</h1>
      <Image className="ml-[170px] mt-2 sm:m-0 sm:w-0" src={'/assets/blog/immer_logo.svg'} width={250} height={1} />
        ...
        <Image className="mb-8 mt-12 sm:w-[120px] w-0" src={'/assets/blog/immer_logo.svg'} width={250} height={1} />
        <Image 
          className=" 2xl:mx-[35%] ml-[25%] w-[50%]  mb-20   " 
          ...
          <p 
            className='ml-10 sm:ml-0 text-center text-black font-light mb-20 text-xl '
            style={{
              display:
                success
                ? "block"
          ...
          <button 
              className="ml-[5%] sm:ml-0 row-start-3 bg-primary text-white mt-8 py-3 w-[100%] rounded-[8px]" 
              type="submit"
              style={{
                display:
                  success
