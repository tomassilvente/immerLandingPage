  ...
  return (
    <header className="flex flex-row w-full sm:h-24 h-20 fixed z-20 top-0 left-0 justify-between items-center p-4 pt-1 pb-1 pr-4 md:pr-10 md:p-12 md:pt-7 md:pb-7 mt-0 sm:p-12 lg:pl-20 lg:pr-20  bg-white">
      ...
      {isFeedOpen
        ...
        <div
        id="Nav-container"
        className="md:w-[91.5%] sm:w-[87%] w-[93%] lg:hidden rounded-lg absolute bg-white text-center mt-44 py-5 text-2xl space-y-5"
      >
        <img onClick={setFeedOpen} src='../../assets/blog/cross.png' className= " absolute ml-[87%] mt-[4%] w-[40px] h-[36px]"/>
        {NavList.map((NavData) => (
